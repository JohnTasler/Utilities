...
{
	[[nodiscard]] inline std::wstring get_variable(PCWSTR variableName)
	{
		std::wstring value;
	...
	[[nodiscard]] inline std::map<std::wstring, std::wstring, string_utility::ordinal_ignore_case_less> get_variables()
	{
